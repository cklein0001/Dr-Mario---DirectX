   ...
   public class Capsule : BottleItem
    {
       ...
       {
           Image MainImage = Bitmap.FromFile("images/capsule32.png");
           
           InitImage0(0, ref  B, ref  BU, ref  BD, ref  BL, ref  BR, ref  B_0, ref  B_1, ref B_2, MainImage);
           InitImage0(32, ref  Y, ref  YU, ref  YD, ref  YL, ref  YR, ref  Y_0, ref  Y_1, ref Y_2, MainImage);
           InitImage0(64, ref  R, ref  RU, ref  RD, ref  RL, ref  RR, ref  R_0, ref  R_1, ref R_2, MainImage);
           MainImage.Dispose();
       }
       ...
       private static void InitImage0(int y, ref ShaderResourceView s, ref  ShaderResourceView u, ref ShaderResourceView d, ref  ShaderResourceView l, ref ShaderResourceView r, ref ShaderResourceView d0, ref ShaderResourceView d1,ref ShaderResourceView d2, Image baseImage)
       {
           u = InitImage(0, y, baseImage);
           d = InitImage(32, y, baseImage);
           l = InitImage(64, y, baseImage);
           r = InitImage(96, y, baseImage);
           s = InitImage(128, y, baseImage);
           d0 = InitImage(160, y, baseImage);
           d1 = InitImage(192, y, baseImage);
           d2 = InitImage(224, y, baseImage);
       }

       private static ShaderResourceView InitImage(int x, int y, Image MainImage)
       {
